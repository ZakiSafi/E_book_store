<x-layout>
    ...
    <div class="w-full flex justify-center items-center p-8">
        <form action="{{ route('user.books.store') }}" method="POST" enctype="multipart/form-data" class="w-full max-w-2xl bg-white p-6 rounded-lg shadow-lg">
            @csrf
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <x-form.input label="Translator" name="translator" />
                ...
                <x-form.input label="Shelf No" name="shelf_no" />
