                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200 ">
                        ...
                        <tr class="hover:bg-gray-50 transition duration-150 ease-in-out p-2">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-gray-700">{{ $book->language }}</td>
                            <td class="px-6 py-4 whitespace-nowrap text-gray-700">{{ $book->shelf_no }}</td>
                            <td class="px-6 py-4 whitespace-nowrap text-gray-700">{{ $book->available_copies }}</td>
