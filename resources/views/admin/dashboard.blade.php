        ...
        <div class="p-4 rounded-lg shadow-lg md:col-span-2">
            ...
            <div class="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-4 mt-8 mb-6">
                ...
                <div class="flex flex-col items-center gap-2 flex-shrink-0">
                    ...
                    @endif
                    <a href="/profile" class="text-md bg-red-500 text-white transition-color duration-300 hover:bg-red-600 rounded-lg px-4 py-1">Edit</a>
                </div>
                <!-- User Info -->
                <div>
            ...
            <div class="mt-8">
                ...
                <div class="flex flex-col sm:flex-row gap-4">
                    <a href="/books/create" class="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition duration-300 text-center">
                        <i class="fa-solid fa-plus mr-2"></i> Upload New Book
                    </a>
                    <a href="/admin/users" class="bg-green-600 text-white px-4 py-2 rounded-lg hover:bg-green-700 transition duration-300 text-center">
                        <i class="fa-solid fa-users mr-2"></i> Manage Users
                    </a>
                    <a href="/admin/books" class="bg-yellow-600 text-white px-4 py-2 rounded-lg hover:bg-yellow-700 transition duration-300 text-center">
