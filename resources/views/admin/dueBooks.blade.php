    ...
    <div class="container w-full max-w-7xl p-4 grid grid-cols-1 gap-4 mt-8">
        ...
        <div class="p-6 rounded-lg shadow-lg bg-white">
            ...
            <div class="flex justify-between items-center mb-6">
                <h2 class="text-3xl font-bold text-gray-800 border-b-2 border-blue-500 pb-2">Due Books</h2>
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <div class="text-center">
                            ...
                            <h1 class="text-3xl font-semibold text-red-600 p-8">No over due books found!</h1>
                        </div>
                        @endif
                    </tbody>
                </table>
