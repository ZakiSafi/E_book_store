<x-layout>
    ...
    <div class="w-full h-auto flex justify-center items-center p-8   ">
        <form action="{{route('user.books.store')}}" method="POST" enctype="multipart/form-data" class="w-full max-w-2xl grid grid-cols-1  bg-white p-6 rounded-lg shadow-md gap-6">
            @csrf
