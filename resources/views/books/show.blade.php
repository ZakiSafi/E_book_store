<x-layout>
    ...
    <div class="container mx-auto w-full max-w-7xl shadow-lg  ">

        <div class="w-full max-w-6xl  grid sm:grid-cols-1 md:grid-cols-[18%,82%] justify-center gap-8">
            @auth
            ...
            <div>
                ...
                <div class="bg-white shadow-lg grid sm:grid-cols-1 md:grid-cols-[25%,70%] gap-5 rounded-lg p-8">
                ...
                <div class="bg-white rounded-lg shadow-lg p-8 self-start">
