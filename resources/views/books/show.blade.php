<x-layout>
    ...
    <div class="container mx-auto w-full max-w-7xl pr-4 sm:pr-6 lg:pr-8">
        <div class="w-full grid grid-cols-1 md:grid-cols-[18%,82%] gap-4 md:gap-16">
            ...
            <div class="w-full">
                <!-- Main Book Card -->
                <div class="bg-white shadow-lg flex flex-col md:flex-row gap-4 md:gap-8 rounded-lg p-4 md:p-8">
                    <!-- Book Cover Section -->
                    <div class="w-full md:w-1/4 flex flex-col items-center gap-4">
                        <img src="{{ asset('storage/' . $book->cover_image) }}" alt="{{ $book->title }}" 
                             class="w-24 h-32 sm:w-32 sm:h-40 md:w-36 md:h-48 bg-center rounded-lg shadow-md object-cover">
                ...
                <div class="bg-white rounded-lg shadow-lg p-4 md:p-8 mt-4 md:mt-8">
                                ...
                                <div class="p-2 rounded-lg shadow-md bg-gray-100 hover:bg-gray-200 transition duration-300 h-full">
                                    <a href="{{ route('books.show', $relatedBook->id) }}" class="text-sm sm:text-base font-semibold text-blue-600 hover:underline flex flex-col items-center">
                                        <img src="{{ asset('storage/' . $relatedBook->cover_image) }}" 
                                             ...
                                             class="w-20 h-24 sm:w-24 sm:h-32 md:w-28 md:h-36 bg-center rounded-lg shadow-md object-cover">
